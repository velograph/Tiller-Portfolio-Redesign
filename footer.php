			...
			<?php while( $wp_query->have_posts() ) : ?>
				...
				<article class="testimonial">
					...
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						width="21.042px" height="17.278px" viewBox="0 0 21.042 17.278" enable-background="new 0 0 21.042 17.278" xml:space="preserve">
						<path fill="#C05F4F" d="M11.044,10.667c0,3.504,2.353,5.568,4.944,5.568c2.352,0,4.368-2.016,4.368-4.464
						c0-2.353-1.632-3.937-3.696-3.937c-0.48,0-0.912,0.097-1.104,0.145c0.528-1.729,2.496-3.792,4.032-4.561l-3.071-2.496
						C13.156,3.323,11.044,6.731,11.044,10.667 M0.244,10.667c0,3.504,2.352,5.568,4.944,5.568c2.352,0,4.368-2.016,4.368-4.464
						c0-2.353-1.68-3.937-3.696-3.937c-0.48,0-0.912,0.097-1.104,0.145c0.48-1.729,2.496-3.792,4.032-4.561L5.716,0.923
						C2.356,3.323,0.244,6.731,0.244,10.667"/>
					</svg>
					<?php the_content(); ?>
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						width="21.042px" height="17.278px" viewBox="0 0 21.042 17.278" enable-background="new 0 0 21.042 17.278" xml:space="preserve">
